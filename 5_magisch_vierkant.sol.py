...
#Itereer over de rijen (denk dat dit kolommen moet worden)
for kolom in range(len(vierkant)):
    #Itereer over de kolommen
    rij_som = 0
    for rij in range(len(vierkant[0])):
        rij_som += vierkant[kolom][rij]
    if rij_som != som:
